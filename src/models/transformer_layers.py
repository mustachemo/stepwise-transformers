...
class TransformerEncoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.feed_forward = PositionWiseFeedForward(d_model, d_ff, dropout_rate, activation)
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        self_attn_output, self_attn_weights = self.self_attention(x, x, x, self_attn_mask)

...
class SimpleTokenizer:
    ...
    def build_vocab(self, texts: List[str]) -> None:
        ...
        max_vocab = self.config.vocab_size - len(self.vocab_to_id)  # Reserve space for special tokens
...
def create_sample_translation_data(num_samples: int = 1000) -> Tuple[List[str], List[str]]:
    """

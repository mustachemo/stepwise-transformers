...
def main(config: DictConfig) -> None:
    ...
    with ClearMLTracker(
        ...
        console.print(f"[green]✓ Data prepared: {len(train_loader)} train, {len(val_loader)} val, {len(test_loader)} test batches[/green]")
        ...
        console.print(f"[green]✓ Model created with {param_counts['total_parameters']:,} parameters[/green]")
